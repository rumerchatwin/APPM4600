...
def driver():
  ...
  (I_simp, uniquex_simp, nsplit_simp) = adaptive_quad(a, b, f, tol, n, method_simp)
  print('The I for simpson method is', I_simp)
  print('The nsplit is', nsplit_simp)

  (I_quad, uniquex_quad, nsplit_quad) = adaptive_quad(a, b, f, tol, n, method_quad)
  print('The I for trap method is', I_quad)
  print('The nsplit is', nsplit_quad)
